...
while true do
	for i,v in pairs (game:GetService("Workspace").TaLights:GetChildren()) do
		spawn(function()
			if v.Name == "Ta1" or v.Name == "Ta2" or v.Name == "Ta3" or v.Name == "Ta22" or v.Name == "Ta23" or v.Name == "Ta24" then
	...
	for i,v in pairs (game:GetService("Workspace").TaLights:GetChildren()) do
		spawn(function()
			if v.Name == "Ta4" or v.Name == "Ta5" or v.Name == "Ta6" or v.Name == "Ta21" or v.Name == "Ta20" or v.Name == "Ta19" then
	...
	for i,v in pairs (game:GetService("Workspace").TaLights:GetChildren()) do
		spawn(function()
			if v.Name == "Ta7" or v.Name == "Ta8" or v.Name == "Ta9" or v.Name == "Ta18" or v.Name == "Ta17" or v.Name == "Ta16" then
				v.Head.Beam.SpotLight.Color = Color3.fromRGB(255, 255, 255)
				v.Head.Beam.light.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
				wait()
				v.Head.Lens.Color = preview1.BackgroundColor3
	...
	for i,v in pairs (game:GetService("Workspace").TaLights:GetChildren()) do
		spawn(function()
			if v.Name == "Ta10" or v.Name == "Ta11" or v.Name == "Ta12" or v.Name == "Ta15" or v.Name == "Ta14" or v.Name == "Ta13" then
				v.Head.Lens.Color = Color3.fromRGB(255, 255, 255)
				v.Head.Beam.SpotLight.Color = Color3.fromRGB(255, 255, 255)
				v.Head.Beam.light.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
				wait()
