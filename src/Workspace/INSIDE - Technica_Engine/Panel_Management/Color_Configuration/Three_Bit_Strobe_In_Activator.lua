...
function onClick()
	local Part1 = game.Workspace.TechnicaPannel:WaitForChild("MainPannel").P3.Buttons.ColorFX.Row4.STROBEIN3.Indicator
	bool = not bool
	if bool then
		script.Three_Bit_Strobe_In_Effect_1.Disabled = false
		TS:Create(Part1, Info, { BackgroundColor3 = Color3.new(0.101961, 0.219608, 1)}):Play()
	else
		script.Three_Bit_Strobe_In_Effect_1.Disabled = true
...
game.Workspace.TechnicaPannel:WaitForChild("MainPannel").P3.Buttons.ColorFX.Row4.STROBEIN3.MouseButton1Click:Connect(onClick)
