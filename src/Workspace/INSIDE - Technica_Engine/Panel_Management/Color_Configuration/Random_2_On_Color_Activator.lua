...
function onClick()
	local Part1 = game.Workspace.TechnicaPannel:WaitForChild("MainPannel").P3.Buttons.ColorFX.Row7.RANDOMCOL2.Indicator
	bool = not bool
	if bool then
...
game.Workspace.TechnicaPannel:WaitForChild("MainPannel").P3.Buttons.ColorFX.Row7.RANDOMCOL2.MouseButton1Click:Connect(onClick)
